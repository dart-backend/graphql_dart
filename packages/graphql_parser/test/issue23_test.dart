...
void main() {
  void testStr<T>(String name, String text) {
    test('name', () {
      ...
      var memberId = conditionValue.fields.singleWhere(
        (f) => f.nameToken.text == 'memberId',
      );
